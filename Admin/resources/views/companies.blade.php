    ...
    <body>
      <div class="row">
        ...
        <div class="col-md-10" style="background-color:#000000;">
          <br>
          <center><span class="badge badge-info">Companies</span></center>
          <form action="/searchjobs" method="get"><div class="row float-right">
           <input class="form-control form-control-sm mr-1" name="jobs" style="width:200px;" type="text" placeholder="Search Companies"> <input type="submit" class="btn btn-success btn-sm mr-4" value="Search"> </div><br>
         </form>
          <br>
          <br>
          <div class="container">
