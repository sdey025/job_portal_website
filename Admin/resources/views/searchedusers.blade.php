...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <div class="col-md-10" style="background-color: #000000;">
       ...
       <center>   <span class="badge badge-primary ">List of Users</span> </center> <div class="row float-right"> <input class="form-control form-control-sm mr-1" name="users" style="width:200px;" type="text" placeholder="Search users"> <input type="submit" class="btn btn-success btn-sm mr-4" value="Search"> </div><br>
        <br>
