...
@endif
<div class="container">
<form method="post" action="{{action('ApplyjobController@store')}}" enctype="multipart/form-data">
  @csrf
  <div class="row">
    <div class="col-md-2">
      <label>Appling ID</label>
    </div>
    <div class="col-md-8">
      <input class="form-control" type="text" value="" name="apply_id"required placeholder="Paste the applying id given in the previous page">
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-md-8">
      <input class="form-control" type="text" value="" name="job_id" required placeholder="Paste the Job id given in the previous page">
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-md-8">
      <input class="form-control" type="file" name="resume" required value="">
    </div>
  </div>
  <br>
  <center><input type="submit" class="btn btn-outline-success"></center>
</form>
</div>
<br>
