...
<br>
<center><span class="badge badge-warning">Report Spam or User</span></center>
<br>
@if($message = Session::get('success'))
<div class="alert alert-danger">
  <button type="button" class="close" data-dismiss="alert">x</button>
      <strong> You Reported this user !!! </strong>
</div>
@endif
<div class="container">
  <form action="/reportuser" method="post">
    @csrf
    <textarea class="form-control is-valid" name="reason" id="validationTextarea" placeholder="Why are you Reporting this people??" required></textarea><br>
    <center>@foreach($users as $row)<input type='hidden' name="reported_user_id" value="{{$row->id}}">@endforeach<button type="submit" class="btn btn-danger">Report</button></center>
