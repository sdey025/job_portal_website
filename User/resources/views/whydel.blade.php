...
<br>
<div class="container">
  <center><label><b>This is why i am deleting my account</b></label></center>
  <br>
<center>
<table id="tblFruits" class="table border border-dark ">

    <tr>
      <td><input id="chkMango" type="checkbox" value="1"/><label for="chkMango">I Got a job!</label></td>
    </tr>
    <tr>
        <td><input id="chkApple" type="checkbox" value="2"/><label for="chkApple">This Website Didn't Helped me to get a job at all</label></td>
    </tr>
    <tr>
        <td><input id="chkBanana" type="checkbox" value="3"/><label for="chkBanana">I got a job from anty outside source</label></td>
    </tr>
    <tr>
        <td><input id="chkGuava" type="checkbox" value="4"/><label for="chkGuava">None of the company is accepting my resume</label></td>
    </tr>
    <tr>
        <td><input id="chkOrange" type="checkbox" value="5"/><label for="chkOrange">others</label></td>
    </tr>

</table>
<br>
<form class="" action="/welcome1/{{Auth::user()->id}}" method="post">
  @csrf
  @method('delete')
