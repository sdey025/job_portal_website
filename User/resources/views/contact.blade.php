...
<section class="mb-4">
    ...
    <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
          ...
          @endif
            <form id="contact-form" name="contact-form" action="{{ url('sendmail/send')}}" method="post">
              @csrf
                <!--Grid row-->
                <div class="row">
            ...
            <div class="text-center text-md-left">
                <button class="btn btn-primary" onclick="document.getElementById('contact-form').submit();" id="sendmail" for="sendmail" value="send" name="send">Send</button>
            </div>
        ...
        <div class="col-md-3 text-center">
            <ul class="list-unstyled mb-0">
                <li><i class="fa fa-map-marker fa-2x"></i>
                    <p>Durgapur, Bidhannagar, INDIA</p>
                </li>
