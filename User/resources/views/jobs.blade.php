            ...
            @if (Route::has('login'))
                <div class="top-right links">
                    @auth
                       ...
                       <a href="/jobs" class="dropdown-item text-dark active"><center>New Jobs</center></a>
...
<br>
<center>
<span class="badge badge-dark text-light" style="width:200px; height:50px; font-size:35px">New Jobs</span></center>
<br>
