...
<html lang="en" dir="ltr">
  ...
  <body>
            ...
            <div class="flex-center position-ref full-height">
              @if (Route::has('login'))
                  <div class="top-right links">
                      @auth
                         <a href="/employer" class="dropdown-item text-dark active"><center>{{ Auth::user()->name }}</center></a>
    ...
    <br>
      ...
      <center><img src="http://localhost/jobfinder.com/job_provider/resources/views/images/User_Avatar.png" style="width:200px; height:200px;" alt="" ></center>
      @else
      <center><img src="http://localhost/jobfinder.com/job_provider/resources/views/images/" alt=""></center>
      @endif
      <br>
    <div class="container">
      <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action list-group-item-primary text-center">Email: {{Auth::user()->email}}</a>
        <a href="#" class="list-group-item list-group-item-action list-group-item-secondary text-center">Working as: {{Auth::user()->curr_job_post}}</a>
        <a href="#" class="list-group-item list-group-item-action list-group-item-success text-center">at: {{Auth::user()->curr_job_com}}</a>
        <a href="#" class="list-group-item list-group-item-action list-group-item-danger text-center">from: {{Auth::user()->curr_job_joining_yr}}</a>
      </div>
    </div>
<br>
